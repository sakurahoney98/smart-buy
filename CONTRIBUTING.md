...
- 📦 Corrigindo bugs
- 🧠 Sugerindo melhorias na lógica do sistema
- 🧪 Escrevendo testes
...
- Certifique-se de que o problema não está relacionado ao seu ambiente (versões incompatíveis, configurações, etc.). Se necessário, veja a seção [Tenho uma dúvida](#tenho-uma-dúvida).
- Veja se já existe uma issue para o problema no [rastreador de bug](https://github.com/sakurahoney98/smart-buy.git/issues?q=label%3Abug).
...
- Pesquise nas [issues](https://github.com/sakurahoney98/smart-buy/issues) se a sugestão já foi feita. Se sim, comente nela em vez de criar uma nova.
...
1. Crie uma issue
- Abra uma [nova issue](https://github.com/sakurahoney98/smart-buy/issues/new) descrevendo:
...
- Clone o repositório forkado para sua máquina:
  ```
  git clone https://github.com/<seu-usuario>/smart-buy.git
  cd smart-buy
  ```
...
1.  Execute os testes.
    ...
    ```shell
      ...
      npm run test:ui
      ```
2. Confirme que o projeto continua buildando corretamente:
    ``` shell
...
3. Envie as alterações para o repositório remoto:
    ...
    ```
4. Volte ao seu projeto no GitHub e clique em "Compare & Pull Request" preenchendo o formulário para envio de PR
...
**Exemplo:**
- feat: implementar ordenação dos itens
- fix: corrigir erro na distribuição dos itens
